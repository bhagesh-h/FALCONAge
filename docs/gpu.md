...
Every figure below comes from `bhagesh/falconage:1.0.0-cuda`, built from the shipping
...
run and the best of three runs, measured in `bhagesh/falconage:1.0.0-cuda` - the image
...
Not for the 25 tier A clocks. It should pay for itself on:
