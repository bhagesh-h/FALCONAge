...
|---|---|---|
| Clock catalogue | 161 entries. **34 tier A score offline**: 31 ship a coefficient file, 3 (PhenoAge, KDM, homeostatic dysregulation) are formulas with none to ship. 28 tier C are tested scaffolds | The 99 tier B entries carry metadata but no traced coefficients |
...
| Clock coefficients | 31 bundled, 28 scaffold-only, 99 untraced (§3.7, §4.7) | tier B narrows as sources are traced |
