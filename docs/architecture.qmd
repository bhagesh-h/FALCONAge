...
|---|---|---|
| Clock catalogue | 161 entries. **25 tier A score offline**: 22 ship a coefficient file, 3 (PhenoAge, KDM, homeostatic dysregulation) are formulas with none to ship. 28 tier C are tested scaffolds | The 108 tier B entries carry metadata but no traced coefficients |
...
| Clock coefficients | 22 bundled, 28 scaffold-only, 108 untraced (§3.7, §4.7) | tier B narrows as sources are traced |
