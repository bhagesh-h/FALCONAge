...
**Docker is the supported path.** One image carries Python, R, the CLI and all 22 bundled clocks
...
| 108 tier B coefficient sources | A per-clock literature hunt; some have no public supplement |
