...
| Tier | n | What you do |
|---|---:|---|
| A | 25 | Nothing. Coefficients ship inside the package. |
| B | 108 | Catalogued, but no primary source has been established, so no coefficients ship. Eleven now record where the material is and what blocks it. |
