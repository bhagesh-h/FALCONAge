...
| Tier | n | What you do |
|---|---:|---|
| A | 34 | Nothing. Coefficients ship inside the package. |
| B | 99 | Catalogued, but no primary source has been established, so no coefficients ship. Eleven now record where the material is and what blocks it. |
