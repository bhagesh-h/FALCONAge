...
_Generated by `test/run_all.py` on 2026-08-25 22:47 UTC · FALCONAge 1.0.0 · registry 1.1.0 · numpy on cpu._
<!-- END GENERATED: stamp -->
...
#                         mammalian, mouse, idat, clinical, disorder
...
**506 Python tests** and **52 R tests**, all passing, with 5 skipped where torch is absent. The R suite contains the conformance test that asserts R and Python scores are
...
| clocks | bundled | untraced | licensed | coefficients_bundled | registry_version |
|---|---|---|---|---|---|
| 175 | 46 | 89 | 40 | 43 | 1.1.0 |
...
|---|---|---|---|---|---|---|---|---|---|
| GSE107143 | 16 | 450K | 460295 | 35 | 137 | AS=8, HC=8 | 32-88 | 30 | 3.6 |
| GSE118468 | 21 | 450K | 485512 | 35 | 137 | COPD=15, HC=6 | 49-82 | 32 | 3.4 |
| GSE130030 | 28 | 450K | 471336 | 35 | 137 | HC=14, MS=14 | 20-65 | 30 | 3.2 |
| GSE151355 | 20 | 450K | 484147 | 35 | 137 | PD=20 | 74-91 | 27 | 3.2 |
| GSE182991 | 27 | EPICv1 | 825177 | 36 | 136 | HC=12, HGPS=15 | 0-41 | 31 | 4.2 |
| GSE214297 | 16 | EPICv1 | 518474 | 34 | 138 | CGL=7, HC=9 | 1-48 | 31 | 3 |
| GSE49909 | 49 | 27K | 27578 | 6 | 166 | HC=40, XOB=9 | 29-85 | 31 | 0.7 |
| GSE56606 | 90 | 27K | 27578 | 6 | 166 | HC=63, T1D=27 | 16-68 | 31 | 0.8 |
| GSE62867 | 6 | 27K | 27578 | 6 | 166 | IHD=6 | 48-67 | 25 | 0.7 |
| GSE71841 | 24 | 450K | 485512 | 35 | 137 | HC=12, RA=12 | 23-57 | 31 | 3.4 |
...
|---|---|---|---|---|---|
| 888987 | 882947 | 6040 | 0 | 0.9603 | 42 |
...
| mccartneyalcohol | -11.25 | 37.29 | -0.596 | 48.55 |
| mccartneybmi | -0.68 | 37.29 | 0.72 | 37.91 |
| mccartneybodyfat | -10.67 | 37.29 | 0.779 | 46.54 |
| mccartneyeducation | -7.71 | 37.29 | -0.311 | 45.07 |
| mccartneyhdlcholesterol | 2.44 | 37.29 | -0.262 | 34.9 |
| mccartneyldlcholesterol | -3.66 | 37.29 | 0.14 | 40.84 |
| mccartneysmoking | 3.63 | 37.29 | 0.582 | 33.4 |
| mccartneytotalcholesterol | -2.27 | 37.29 | -0.465 | 39.53 |
| mccartneytotalhdlratio | -0.2 | 37.29 | -0.139 | 37.37 |
| mccartneywhr | -0.35 | 37.29 | 0.352 | 37.61 |
...
## Disorder, repertoire and coefficient mass

The readouts that are not clocks, run on `GSE182991`: EPIC, and the widest age range in the
corpus. Every statistic below is either about age-related variance or is reported per sample, so
a single-age cohort would show nothing.

<!-- BEGIN GENERATED: disorder -->
| dataset | n_samples | n_sites | entropy_mean | entropy_sd | drift_mean | sites_tested | sites_rising_fdr | sites_rising_nominal_p01 | barometer | mean_sd | barometer_selection | clonality_clocks | clonality_median_slope | clonality_worst_years |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| GSE182991 | 27 | 825177 | 0.695265 | 0.00724507 | 0.0248086 | 825175 | 0 | 952 | 37.8824 | 0.0397924 | nominal p<0.01, uncorrected | 42 | -0.494 | 66.162 |
<!-- END GENERATED: disorder -->

**How to read it.** `entropy_mean` near 0.70 says the average site sits well away from full
commitment, which is what a healthy bimodal beta distribution looks like when summarised to one
number. It is comparable between samples processed identically and between nothing else.

`sites_rising_fdr` is **zero**, and that is the correct answer rather than a gap. Twenty-seven
samples split into three bins of nine, against roughly 820,000 Brown-Forsythe tests, has almost
no power once Benjamini-Hochberg is applied. The barometer is therefore computed over a nominal
`p < 0.01` selection and the output column says so on every row. A barometer that means anything
needs a cohort in the hundreds; reporting the FDR count next to the nominal one is how that stays
visible instead of being absorbed into a number.

### What clone structure alone does to a clock

Cell-type fractions are held identical across all 48 simulated samples, so nothing below is
composition. The only thing that varies is the effective number of clones in one compartment.
The derivation in `falconage.immune` predicts a spread falling as `1/sqrt(N_eff)`, which is a
log-log slope of -0.5.

<!-- BEGIN GENERATED: clonality -->
| clock | log_log_slope | spread_at_2_clones | spread_at_most_clones |
|---|---|---|---|
| mccartneyhdlcholesterol | -0.718 | 0.1005 | 0.0097 |
| stemtoc | -0.707 | 0.0066 | 0.0008 |
| zhangmortality | -0.695 | 0.0886 | 0.0094 |
| epicmithypo | -0.684 | 0.0003 | 0 |
| skinandblood | -0.662 | 0.5495 | 0.0503 |
| dunedinpoam38 | -0.65 | 0.0232 | 0.0033 |
| vidalbralo | -0.64 | 1.2842 | 0.1807 |
| hrsinchphenoage | -0.621 | 2.063 | 0.1696 |
| dnamphenoage | -0.605 | 4.3509 | 0.4655 |
| leerobust | -0.588 | 0.4282 | 0.0617 |
| horvath2013 | -0.559 | 1.5404 | 0.3429 |
| leerefinedrobust | -0.558 | 0.2944 | 0.0368 |
<!-- END GENERATED: clonality -->

The measured median slope across 42 clocks is **-0.494**, interquartile range -0.559 to -0.415.
The derivation predicts -0.5 and did not have the simulation fitted to it, so this is a check
that passed rather than a curve that was tuned.

`spread_at_2_clones` is in each clock's own unit, which is why the table is sorted by slope and
not by spread: `epitoc2` heads the raw spread column at 66, and that number is cell divisions,
not years. Among the clocks that do report years, `dnamphenoage` moves **4.35 years** between an
effectively-two-clone compartment and a diverse one, `horvath2013` moves 1.54 years, and both fall
to well under a year once the compartment holds a few hundred effective clones.

Cell-type fractions were identical for every one of those samples. Whatever this is, composition
adjustment cannot remove it, and no published blood clock currently measures it.

### Where a clock's weight sits

Coefficient mass shared with three anchor clocks, over every clock that ships a coefficient
vector. No external annotation is needed to ask a real question with this: how much of one
clock's weight sits on CpGs another clock also uses.

<!-- BEGIN GENERATED: coefficient_mass -->
| clock | n_features | total_abs_weight | horvath2013_n | horvath2013_frac_sites | horvath2013_frac_mass | dnamphenoage_n | dnamphenoage_frac_sites | dnamphenoage_frac_mass |
|---|---|---|---|---|---|---|---|---|
| horvath2013 | 353 | 86.8285 | 353 | 1 | 1 | 41 | 0.116147 | 0.196474 |
| vidalbralo | 8 | 225.8 | 3 | 0.375 | 0.383082 | 3 | 0.375 | 0.225864 |
| lin | 99 | 1385.92 | 22 | 0.222222 | 0.282017 | 22 | 0.222222 | 0.271975 |
| skinandblood | 391 | 57.6592 | 60 | 0.153453 | 0.114432 | 58 | 0.148338 | 0.110607 |
| weidner | 3 | 214.8 | 1 | 0.333333 | 0.110335 | 2 | 0.666667 | 0.889665 |
| dnamphenoage | 513 | 3490.34 | 41 | 0.079922 | 0.0999634 | 513 | 1 | 1 |
| hannum | 71 | 628.268 | 6 | 0.084507 | 0.0796476 | 6 | 0.084507 | 0.0817008 |
| hrsinchphenoage | 959 | 2323.7 | 13 | 0.0135558 | 0.0298392 | 30 | 0.0312826 | 0.0399085 |
| pedbe | 94 | 11.5223 | 1 | 0.0106383 | 0.0273593 | 1 | 0.0106383 | 0.0273593 |
| zhangen | 514 | 261.067 | 11 | 0.0214008 | 0.0255829 | 15 | 0.0291829 | 0.0341588 |
| corticalclock | 347 | 50.5011 | 5 | 0.0144092 | 0.0178015 | 5 | 0.0144092 | 0.0171489 |
| knight | 148 | 345.246 | 6 | 0.0405405 | 0.0129578 | 8 | 0.0540541 | 0.0353593 |
<!-- END GENERATED: coefficient_mass -->

**Why mass and not count.** The two columns disagree, and the disagreement is the finding.
Where `frac_mass` exceeds `frac_sites`, the shared probes are the heavy ones, and two clocks that
share their heaviest features will agree with each other for reasons that have nothing to do
with either being right.
...
- **The 40 licensed scaffold clocks.** Their feature alignment and tensor shapes are exercised by the unit
