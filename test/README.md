...
Twenty-three of the thirty-three files are trust-on-first-use --- GEO publishes sizes but no
digests --- so `verify` proves the bytes have not changed since *you* fetched them, which is a
