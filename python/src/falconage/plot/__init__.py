...
__all__ = [
    ...
    "clock_chord", "clock_pca", "clock_radar", "clock_scatter_matrix", "coverage_bar",
    "forest", "missingness",
    "platform_comparison", "save_all", "sex_check", "spec", "study_comparison",
    "timecourse", "trajectory", "clock_atlas",
]
...
def save_all(result, outdir, *, data=None, bench=None, acc=None, age_col: str = "age",
             ...
             dataset_col: str | None = None, max_per_clock: int = 4) -> dict[str, Path]:
